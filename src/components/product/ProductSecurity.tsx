    ...
    <section className={`section-padding bg-secondary/30 ${className}`}>
      <div className="container-max">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
          <div className="card p-6 text-center" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="card p-6 text-center" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="card p-6 text-center" style={{ animationDelay: '0.3s' }}>
          ...
          <div className="card p-6 text-center" style={{ animationDelay: '0.4s' }}>
        ...
        <div className="mt-12 text-center fade-scale" style={{ animationDelay: '0.5s' }}>
