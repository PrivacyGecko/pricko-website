...
const CookieConsent: React.FC<CookieConsentProps> = ({ onAccept, onReject }) => {
  ...
  return (
    <>
      {showPreferences && (
        <div
          className="fixed inset-0 bg-black/60 z-[999] backdrop-blur-sm modal-backdrop visible"
          onClick={() => setShowPreferences(false)}
        />
      )}

      <div
        className="fixed bottom-0 left-0 right-0 z-[1000] p-4 md:p-6 slide-up-fade"
        role="dialog"
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <button
                  ...
                  className="btn-primary flex-1 sm:flex-none px-6 py-3 rounded-lg font-semibold hover-scale transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-secondary"
                ...
                <button
                  ...
                  className="flex-1 sm:flex-none px-6 py-3 bg-border/50 hover:bg-border text-white rounded-lg font-semibold hover-scale transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-secondary"
                ...
                <button
                  ...
                  className="flex-1 sm:flex-none px-6 py-3 border-2 border-accent/50 hover:border-accent text-white rounded-lg font-semibold hover-scale transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-secondary"
      ...
      {showPreferences && (
        <div
          className="fixed inset-0 z-[1000] flex items-center justify-center p-4 modal-content visible"
          role="dialog"
          aria-modal="true"
          ...
          <div className="bg-secondary border border-accent/30 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-y-auto">
            ...
            <div className="sticky bottom-0 bg-secondary border-t border-border p-6 flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="btn-primary flex-1 px-6 py-3 rounded-lg font-semibold hover-scale transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-secondary"
