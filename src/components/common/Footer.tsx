      ...
      <div className="container-max section-padding relative">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  type="submit"
                  className="btn-primary whitespace-nowrap active:scale-95 transition-transform"
                >
                  Subscribe
                </button>
              </form>
            ...
            >
              {socialLinks.map((social) => (
                <a
                  ...
                  className="group relative w-12 h-12 bg-border/50 rounded-xl flex items-center justify-center hover:bg-accent hover:text-black transition-all duration-300 overflow-hidden hover:-translate-y-1 active:scale-95"
                >
        ...
        >
          ...
          <div className="flex items-center space-x-6 text-sm">
            <div
              className="flex items-center space-x-2 text-muted hover:scale-105 transition-transform"
            >
