...
const GeckoSharePage: React.FC = () => {
  ...
  const howItWorks = [
    {
      ...
      description: "No signup required. Visit GeckoShare and get an instant, unique upload link. Works in any browser."
    },
    {
      step: 2,
  ...
  const faqs = [
    {
      ...
      answer: "GeckoShare uses client-side AES-256 encryption. Files are encrypted in your browser before upload, meaning we never see your unencrypted data. Zero-knowledge architecture ensures maximum privacy."
    },
    {
    ...
    {
      question: "Can I use GeckoShare without an account?",
    ...
    {
      question: "How is GeckoShare different from Dropbox or Google Drive?",
      answer: "GeckoShare is zero-knowledge encrypted (we can't see your files), requires no signup for basic use, and is designed for secure one-time sharing, not long-term storage. Privacy-first, not profit-first."
    },
    {
  ...
  return (
    <ProductPageTemplate 
      ...
      faqs={faqs}
      pageTitle="GeckoShare - Encrypted File Sharing | Privacy Gecko"
