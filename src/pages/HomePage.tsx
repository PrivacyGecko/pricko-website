            ...
            <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
              ...
              >
                <div>
                  ...
                  >
                    ...
                    <div
                      className="card-interactive bg-secondary p-6 hover:-translate-y-1 transition-transform"
                    >
                ...
                >
                  <a
                    href="/how-to-buy"
                    className="btn-primary inline-flex items-center justify-center gap-3 text-lg px-10 py-5 shadow-lg hover:scale-105 active:scale-95 transition-transform"
                  >
                  ...
                  <a
                    ...
                    className="btn-secondary inline-flex items-center justify-center gap-3 text-lg px-10 py-5 hover:scale-105 active:scale-95 transition-transform"
                  >
              ...
              >
                ...
                <div className="relative w-96 h-96 flex items-center justify-center">
                  ...
                  >
                    <div className="w-80 h-80 rounded-full border border-accent/20"></div>
                  </div>
                  <div
                    className="absolute inset-0 flex items-center justify-center"
                  >
                    <div className="w-72 h-72 rounded-full border border-accent/10"></div>
                  </div>
                ...
                <div
                  className="w-full max-w-md p-4 card-interactive hover:-translate-y-1 transition-transform"
                >
