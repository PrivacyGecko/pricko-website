...
const HomePage: React.FC = () => {
  const tools = [
    ...
    },
    {
      ...
      title: "GeckoLock",
      description: "Zero-knowledge password manager with AES-256 encryption and cross-platform sync.",
