    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container-max relative z-10 section-padding">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-secondary/50 border border-accent/20 rounded-2xl p-6 md:p-8 backdrop-blur-sm mb-12 max-w-2xl mx-auto hover:border-accent/40 transition-colors">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <button
              onClick={() => navigate('/')}
              className="btn-primary inline-flex items-center justify-center gap-3 text-lg px-8 py-4 shadow-lg hover:scale-105 transition-transform"
            ...
            <Link to="/tools">
              <button
                className="btn-secondary inline-flex items-center justify-center gap-3 text-lg px-8 py-4 hover:scale-105 transition-transform"
              ...
              {popularPages.map((page) => {
                ...
                return (
                  <div key={page.path}>
                    <Link to={page.path}>
                      <div
                        className="card text-center h-full hover:bg-secondary/80 cursor-pointer group hover:-translate-y-1 transition-transform border border-transparent hover:border-accent/50"
                        role="button"
                        aria-label={`Navigate to ${page.label}`}
                      >
                        <div className="text-4xl text-accent mb-4 inline-block group-hover:scale-110 transition-transform">
                        ...
                        <div className="mt-3 text-accent opacity-0 group-hover:opacity-100 transition-opacity transform group-hover:translate-x-0 -translate-x-2">
          ...
          {/* Help Section */}
          <div className="text-center bg-gradient-to-r from-accent/10 via-accent/5 to-accent/10 border border-accent/20 rounded-2xl p-6 md:p-8 backdrop-blur-sm hover:border-accent/40 transition-colors">
            ...
            <Link to="/contact">
              <button
                className="btn-primary inline-flex items-center gap-3 px-6 py-3 hover:scale-105 transition-transform"
